...
const checkpoints: Checkpoint[] = [
  ...
  {
    id: "S2",
    title: "Install Governance and Operational Controls",
    goal: "Define how agents are approved, monitored, audited, and stopped before they perform sensitive company work.",
    status: "locked",
    actions: [
      "Classify agent actions by business impact and required approval level",
      "Define access controls, audit logs, monitoring, and escalation paths",
      "Test failure cases and document how operators pause or roll back workflows",
      "Review security, privacy, legal, and compliance requirements before launch",
    ],
    constraints: [
      "Agents cannot approve their own high-impact actions",
      "Sensitive credentials and production access must follow least privilege",
      "Every critical workflow needs a named human owner and incident process",
    ],
    deliverables: [
      "Agent action and approval matrix",
      "Access-control and audit-log specification",
      "Failure-mode evaluation and rollback runbook",
      "Operational risk and launch-readiness review",
    ],
    helpingLessons: "Production Security + Agent Evaluation",
    lessonsLink: "/docs/AI-Cloud-Native-Development/production-security",
    successSignal: "Every high-impact action has an owner, approval rule, audit trail, and tested stop procedure.",
  },
  {
    id: "A1",
